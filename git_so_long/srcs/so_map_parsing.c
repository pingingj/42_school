...
/*   Updated: 2025/02/13 21:02:34 by dgarcez-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../incs/so_header.h"

static bool	check_boarders(t_mlx map)
{
	int		i;
	int		j;
	size_t	size;
...
static void	flood_map(t_mlx *map, int x, int y)
{
...
static bool	check_flood(t_mlx map)
{
	int	i;
	int	j;
...
static bool	check_chars(t_mlx map)
{
	int	i;
	int	j;
